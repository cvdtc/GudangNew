import 'dart:convert';
import 'package:GUDANGPROJECT/api/models/asuransi/asuransi.model.dart';
import 'package:GUDANGPROJECT/api/models/customer/customer.model.dart';
import 'package:GUDANGPROJECT/api/models/history/history.model.dart';
import 'package:GUDANGPROJECT/api/models/jenisproduk/jenisproduk.model.dart';
import 'package:GUDANGPROJECT/api/models/mystorage/mystorageModel.dart';
import 'package:GUDANGPROJECT/api/models/order/order.model.dart';
import 'package:GUDANGPROJECT/api/models/order/order.sukses.model.dart';
import 'package:GUDANGPROJECT/api/models/paymentgateway/paymentgateway.model.dart';
import 'package:GUDANGPROJECT/api/models/pengguna/pengguna.model.dart';
import 'package:GUDANGPROJECT/api/models/pin/edit.password.model.dart';
import 'package:GUDANGPROJECT/api/models/pin/pin.model.dart';
...
class ApiService {
  final String baseUrl = "http://192.168.43.163:9992/api/";
