...
import 'package:GUDANGPROJECT/component/PaymentPage/Pembayaran.Input.dart';
import 'package:GUDANGPROJECT/widget/datePicker.dart';
...
//    print(asuransi);
//    print(asuransie);
//    if(asuransie==0) asuransi = "0";
//    asuransi = "50000";
//  print(asuransi.toString());
...
//                                valueText: new DateFormat.yMd().format(_date),
                                    ...
                                    onPressed: () {
                                      ...
                                      dtAwal = _date;
//                                  print(dtAwal.difference(dtAwal).inDays);
                                    },
                                  ),
                                  TanggalSet(
                                    labelText: tglAkhir,
